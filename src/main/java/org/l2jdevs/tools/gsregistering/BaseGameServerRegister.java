 ...
 */
package org.l2jdevs.tools.gsregistering;
...
import org.l2jdevs.tools.i18n.LanguageControl;
...
public abstract class BaseGameServerRegister
{
	...
	private static void printHelp(ResourceBundle bundle)
	{
		String[] help =
		{
			...
			bundle.getString("bugReports") + " http://www.l2jdevs.org"
			 ...
			 * "-u, --unregister <id>|all\t\tRemoves GameServer denoted by <id>, use \"all\" for removing all registered GameServers", "", "Copyright (C) L2J Team 2008-2012.", "Report bugs: http://www.l2jdevs.org"
			 */
		};
