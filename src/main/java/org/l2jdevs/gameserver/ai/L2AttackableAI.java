...
import org.l2jdevs.gameserver.data.sql.impl.TerritoryTable;
...
import org.l2jdevs.gameserver.model.actor.instance.L2FestivalMonsterInstance;
import org.l2jdevs.gameserver.model.actor.instance.L2FriendlyMobInstance;
...
public class L2AttackableAI extends L2CharacterAI implements Runnable
{
	...
	private boolean autoAttackCondition(L2Character target)
	{
		...
		if (me instanceof L2FriendlyMobInstance)
		{
			...
			{
                            return L2RogueLike.doIWantToAttackPC(me, player) //
                                && GeoData.getInstance().canSeeTarget(me, target); // Los Check
			}
			return false;
		}
		else
