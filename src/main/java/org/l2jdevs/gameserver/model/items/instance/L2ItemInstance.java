 ...
 */
package org.l2jdevs.gameserver.model.items.instance;

import static org.l2jdevs.gameserver.model.itemcontainer.Inventory.ADENA_ID;
...
import org.l2jdevs.gameserver.model.DropProtection;
...
import org.l2jdevs.gameserver.model.actor.knownlist.NullKnownList;
...
import org.l2jdevs.gameserver.model.items.type.ItemType;
...
import org.l2jdevs.gameserver.model.options.Options;
import org.l2jdevs.gameserver.model.stats.functions.AbstractFunction;
import org.l2jdevs.gameserver.network.SystemMessageId;
import org.l2jdevs.gameserver.network.serverpackets.DropItem;
import org.l2jdevs.gameserver.network.serverpackets.GetItem;
import org.l2jdevs.gameserver.network.serverpackets.InventoryUpdate;
import org.l2jdevs.gameserver.network.serverpackets.SpawnItem;
...
public final class L2ItemInstance extends L2Object
{
	...
	public int getMerchantPriceBuy() {
		return _item.getMerchantPriceBuy();
	}

	public int getMerchantPriceSell() {
		return _item.getMerchantPriceSell();
	}
