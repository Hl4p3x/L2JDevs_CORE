...
import org.l2jdevs.gameserver.enums.StatFunction;
...
public final class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applayCond, String functionName, int order, Stats stat, double value)
	{
		...
		try
		{
			final Class<?> functionClass = Class.forName("org.l2jdevs.gameserver.model.stats.functions.Func" + function.getName());
