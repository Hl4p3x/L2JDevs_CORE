...
import org.l2jdevs.gameserver.ItemsAutoDestroy;
...
import org.l2jdevs.gameserver.ai.L2PlayerAI;
import org.l2jdevs.gameserver.ai.L2SummonAI;
import org.l2jdevs.gameserver.cache.WarehouseCacheManager;
import org.l2jdevs.gameserver.communitybbs.BB.Forum;
import org.l2jdevs.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import org.l2jdevs.gameserver.enums.DuelState;
...
import org.l2jdevs.gameserver.enums.PlayerAction;
import org.l2jdevs.gameserver.enums.PrivateStoreType;
import org.l2jdevs.gameserver.enums.Race;
import org.l2jdevs.gameserver.enums.ShortcutType;
import org.l2jdevs.gameserver.enums.ShotType;
import org.l2jdevs.gameserver.enums.Team;
...
import org.l2jdevs.gameserver.instancemanager.DuelManager;
...
import org.l2jdevs.gameserver.model.L2AccessLevel;
import org.l2jdevs.gameserver.model.L2Clan;
import org.l2jdevs.gameserver.model.L2ClanMember;
import org.l2jdevs.gameserver.model.L2ContactList;
import org.l2jdevs.gameserver.model.L2EnchantSkillLearn;
...
import org.l2jdevs.gameserver.model.L2PremiumItem;
import org.l2jdevs.gameserver.model.L2Radar;
import org.l2jdevs.gameserver.model.L2RecipeList;
import org.l2jdevs.gameserver.model.L2Request;
import org.l2jdevs.gameserver.model.L2SkillLearn;
import org.l2jdevs.gameserver.model.L2World;
import org.l2jdevs.gameserver.model.L2WorldRegion;
import org.l2jdevs.gameserver.model.Location;
import org.l2jdevs.gameserver.model.Macro;
import org.l2jdevs.gameserver.model.MacroList;
...
import org.l2jdevs.gameserver.model.ShortCuts;
import org.l2jdevs.gameserver.model.Shortcut;
import org.l2jdevs.gameserver.model.TeleportBookmark;
...
import org.l2jdevs.gameserver.model.UIKeysSettings;
import org.l2jdevs.gameserver.model.actor.L2Attackable;
import org.l2jdevs.gameserver.model.actor.L2Character;
import org.l2jdevs.gameserver.model.actor.L2Decoy;
...
import org.l2jdevs.gameserver.model.actor.appearance.PcAppearance;
import org.l2jdevs.gameserver.model.actor.knownlist.PcKnownList;
import org.l2jdevs.gameserver.model.actor.stat.PcStat;
import org.l2jdevs.gameserver.model.actor.status.PcStatus;
import org.l2jdevs.gameserver.model.actor.tasks.player.DismountTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.FameTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.GameGuardCheckTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.InventoryEnableTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.LookingForFishTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.PetFeedTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.PvPFlagTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.RecoBonusTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.RecoBonusTaskEnd;
import org.l2jdevs.gameserver.model.actor.tasks.player.RecoGiveTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.RentPetTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.ResetChargesTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.ResetSoulsTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.SitDownTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.StandUpTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.VitalityTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import org.l2jdevs.gameserver.model.actor.tasks.player.WaterTask;
import org.l2jdevs.gameserver.model.actor.templates.L2PcTemplate;
import org.l2jdevs.gameserver.model.actor.transform.Transform;
import org.l2jdevs.gameserver.model.base.ClassId;
import org.l2jdevs.gameserver.model.base.ClassLevel;
import org.l2jdevs.gameserver.model.base.PlayerClass;
...
import org.l2jdevs.gameserver.model.entity.Duel;
...
import org.l2jdevs.gameserver.model.entity.NevitSystem;
import org.l2jdevs.gameserver.model.entity.RecoBonus;
...
import org.l2jdevs.gameserver.model.events.impl.character.player.OnPlayerStand;
...
import org.l2jdevs.gameserver.model.fishing.L2Fish;
import org.l2jdevs.gameserver.model.fishing.L2Fishing;
import org.l2jdevs.gameserver.model.holders.AdditionalSkillHolder;
import org.l2jdevs.gameserver.model.holders.ItemHolder;
import org.l2jdevs.gameserver.model.holders.PlayerEventHolder;
import org.l2jdevs.gameserver.model.holders.SkillHolder;
import org.l2jdevs.gameserver.model.holders.SkillUseHolder;
...
import org.l2jdevs.gameserver.model.itemcontainer.PcRefund;
import org.l2jdevs.gameserver.model.itemcontainer.PcWarehouse;
import org.l2jdevs.gameserver.model.itemcontainer.PetInventory;
...
import org.l2jdevs.gameserver.model.multisell.PreparedListContainer;
...
import org.l2jdevs.gameserver.model.variables.AccountVariables;
...
import org.l2jdevs.gameserver.network.serverpackets.AbstractHtmlPacket;
import org.l2jdevs.gameserver.network.serverpackets.ActionFailed;
import org.l2jdevs.gameserver.network.serverpackets.ChangeWaitType;
...
import org.l2jdevs.gameserver.network.serverpackets.ExAutoSoulShot;
import org.l2jdevs.gameserver.network.serverpackets.ExBrExtraUserInfo;
import org.l2jdevs.gameserver.network.serverpackets.ExDominionWarStart;
import org.l2jdevs.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import org.l2jdevs.gameserver.network.serverpackets.ExFishingEnd;
import org.l2jdevs.gameserver.network.serverpackets.ExFishingStart;
...
import org.l2jdevs.gameserver.network.serverpackets.ExOlympiadMode;
import org.l2jdevs.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import org.l2jdevs.gameserver.network.serverpackets.ExSetCompassZoneCode;
import org.l2jdevs.gameserver.network.serverpackets.ExStartScenePlayer;
...
import org.l2jdevs.gameserver.network.serverpackets.FriendStatusPacket;
import org.l2jdevs.gameserver.network.serverpackets.GameGuardQuery;
import org.l2jdevs.gameserver.network.serverpackets.GetOnVehicle;
...
import org.l2jdevs.gameserver.network.serverpackets.LeaveWorld;
import org.l2jdevs.gameserver.network.serverpackets.MagicSkillUse;
import org.l2jdevs.gameserver.network.serverpackets.MyTargetSelected;
import org.l2jdevs.gameserver.network.serverpackets.NicknameChanged;
import org.l2jdevs.gameserver.network.serverpackets.ObservationMode;
import org.l2jdevs.gameserver.network.serverpackets.ObservationReturn;
import org.l2jdevs.gameserver.network.serverpackets.PartySmallWindowUpdate;
import org.l2jdevs.gameserver.network.serverpackets.PetInventoryUpdate;
...
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreListBuy;
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreListSell;
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreManageListSell;
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import org.l2jdevs.gameserver.network.serverpackets.PrivateStoreMsgSell;
import org.l2jdevs.gameserver.network.serverpackets.RecipeShopMsg;
import org.l2jdevs.gameserver.network.serverpackets.RecipeShopSellList;
import org.l2jdevs.gameserver.network.serverpackets.RelationChanged;
import org.l2jdevs.gameserver.network.serverpackets.Ride;
import org.l2jdevs.gameserver.network.serverpackets.ServerClose;
...
import org.l2jdevs.gameserver.network.serverpackets.SkillList;
import org.l2jdevs.gameserver.network.serverpackets.Snoop;
...
import org.l2jdevs.gameserver.network.serverpackets.StopMove;
import org.l2jdevs.gameserver.network.serverpackets.SystemMessage;
import org.l2jdevs.gameserver.network.serverpackets.TargetSelected;
import org.l2jdevs.gameserver.network.serverpackets.TargetUnselected;
import org.l2jdevs.gameserver.network.serverpackets.TradeDone;
import org.l2jdevs.gameserver.network.serverpackets.TradeOtherDone;
import org.l2jdevs.gameserver.network.serverpackets.TradeStart;
...
import org.l2jdevs.util.EnumIntBitmask;
...
public final class L2PcInstance extends L2Playable
{
	...
	private boolean _canRevive = Config.L2JMOD_ALLOW_REVIVE;
	...
	public List<Quest> getAllCompletedQuests() {
            ...
            for(QuestState qs : _quests.values()) {
                if ((qs == null) || (qs.getQuest() == null) //
                    ...
                    continue;
                if(qs.getState() == State.COMPLETED) // isCompleted()
                    quests.add(qs.getQuest());
            }
            return quests;
        }
		...
		else
		{
			...
			if (ptarget != null)
			{
				if (answer == 1)
				{
					...
					ptarget.sendMessage(LanguageData.getInstance().getMsg(ptarget, "request_engage_accepted"));
				}
				else
				{
					ptarget.sendMessage(LanguageData.getInstance().getMsg(ptarget, "request_engage_denied"));
				}
			}
		}
	}
	...
	public boolean mountPlayer(L2Summon pet)
	{
		if ((pet != null) && pet.isMountable() && !isMounted() && !isBetrayed())
		{
			...
			else if (getInventory().getItemByItemId(9819) != null)
			{
				sendPacket(ActionFailed.STATIC_PACKET);
				// FIXME: Wrong Message
				sendMessage(LanguageData.getInstance().getMsg(this, "no_mount_in_flag_mode"));
				return false;
			}
	...
	private boolean checkUseMagicConditions(Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (isInDuel())
		{
			...
			{
				sendMessage(LanguageData.getInstance().getMsg(cha, "duel_no_action"));
				sendPacket(ActionFailed.STATIC_PACKET);
				return false;
			}
		}
	...
	public void onPlayerEnter()
	{
		...
		if (SevenSigns.getInstance().isSealValidationPeriod() || SevenSigns.getInstance().isCompResultsPeriod())
		{
			if (!isGM() && isIn7sDungeon() && (SevenSigns.getInstance().getPlayerCabal(getObjectId()) != SevenSigns.getInstance().getCabalHighestScore()))
			{
				...
				sendMessage(LanguageData.getInstance().getMsg(this, "ss_teleported_nearest_seal"));
			}
		}
		else
		{
			if (!isGM() && isIn7sDungeon() && (SevenSigns.getInstance().getPlayerCabal(getObjectId()) == SevenSigns.CABAL_NULL))
			{
				teleToLocation(TeleportWhereType.TOWN);
				setIsIn7sDungeon(false);
				sendMessage(LanguageData.getInstance().getMsg(this, "ss_teleported_nearest_cabal"));
			}
		}
		...
		if (isGM())
		{
			if (isInvul())
			{
				sendMessage(LanguageData.getInstance().getMsg(this, "enter_in_mode_invulnerable"));
			}
			if (isInvisible())
			{
				sendMessage(LanguageData.getInstance().getMsg(this, "enter_in_mode_invisible"));
			}
			if (isSilenceMode())
			{
				sendMessage(LanguageData.getInstance().getMsg(this, "enter_in_mode_silence"));
			}
		}
	...
	public void onActionRequest()
	{
		...
		{
			sendMessage(LanguageData.getInstance().getMsg(this, "teleport_protection_ended"));
		}
		setProtection(false);
	...
	public void startFishing(int _x, int _y, int _z)
	{
		...
		{
			sendMessage(LanguageData.getInstance().getMsg(this, "fish_dot_defined"));
			endFishing(false);
			return;
		}
	 ...
	 * @param includeQuestInventory check also quest inventory
	 * @return
	 */
    public boolean isInventoryUnder90(final boolean includeQuestInventory) {
        final boolean generalLimitReached = //
            getInventory().getSize() <= getInventoryLimit() * 9 / 10;
        if(includeQuestInventory)
            return generalLimitReached //
                || getInventory().getSize(false) <= getQuestInventoryLimit() * 9 / 10;
        return generalLimitReached;
    }
	...
	public void storeRecommendations()
	{
		...
		if(getUptime() > 42000) // at least 42 s in the world... (time in ms)
