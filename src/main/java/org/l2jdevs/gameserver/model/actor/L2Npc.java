...
import org.l2jdevs.gameserver.datatables.NpcPersonalAIData;
import org.l2jdevs.gameserver.enums.AISkillScope;
import org.l2jdevs.gameserver.enums.AIType;
...
import org.l2jdevs.gameserver.model.actor.knownlist.NpcKnownList;
import org.l2jdevs.gameserver.model.actor.stat.NpcStat;
import org.l2jdevs.gameserver.model.actor.status.NpcStatus;
...
import org.l2jdevs.gameserver.model.zone.type.L2TownZone;
...
import org.l2jdevs.gameserver.network.serverpackets.ExChangeNpcState;
...
public class L2Npc extends L2Character
{
	...
	public static final int INTERACTION_DISTANCE = Config.L2JMOD_INTERACTION_DISTANCE;
	...
	public boolean canInteract(L2PcInstance player)
	{
		...
		else if (!isInsideRadius(player, Config.L2JMOD_INTERACTION_DISTANCE, true, false))
		{
			return false;
		}
