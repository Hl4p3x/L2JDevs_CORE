...
import org.l2jdevs.gameserver.model.zone.L2ZoneForm;
import org.l2jdevs.gameserver.model.zone.L2ZoneRespawn;
import org.l2jdevs.gameserver.model.zone.L2ZoneType;
import org.l2jdevs.gameserver.model.zone.form.ZoneCuboid;
import org.l2jdevs.gameserver.model.zone.form.ZoneCylinder;
import org.l2jdevs.gameserver.model.zone.form.ZoneNPoly;
import org.l2jdevs.gameserver.model.zone.type.L2ArenaZone;
import org.l2jdevs.gameserver.model.zone.type.L2OlympiadStadiumZone;
import org.l2jdevs.gameserver.model.zone.type.L2RespawnZone;
import org.l2jdevs.gameserver.model.zone.type.NpcSpawnTerritory;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("org.l2jdevs.gameserver.model.zone.type.L2" + zoneType);
