...
public final class RequestExOustFromMPCC extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((target != null) && target.isInParty() && activeChar.isInParty() && activeChar.getParty().isInCommandChannel() && target.getParty().isInCommandChannel() && activeChar.getParty().getCommandChannel().getLeader().equals(activeChar)
