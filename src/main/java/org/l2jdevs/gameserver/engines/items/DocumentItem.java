 ...
 */
package org.l2jdevs.gameserver.engines.items;
...
import org.l2jdevs.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("org.l2jdevs.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
