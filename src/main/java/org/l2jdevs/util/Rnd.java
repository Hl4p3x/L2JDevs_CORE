...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see org.l2jdevs.util.Rnd#nextDouble()
		 */
		 ...
		 * @return A random integer number from 0 to n-1
		 */
		public final long get(final long n)
		{
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link org.l2jdevs.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see org.l2jdevs.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see org.l2jdevs.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see org.l2jdevs.util.Rnd#get(int n)
	 */
